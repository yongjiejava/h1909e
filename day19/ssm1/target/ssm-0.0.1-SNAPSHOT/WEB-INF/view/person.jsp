	...
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" readonly="readonly" class="laydate-icon form-control layer-date" id="txt_search_start" name="starttime" />
                     <input placeholder="结束时间" readonly="readonly" class="laydate-icon form-control layer-date" id="txt_search_end" name="endtime" />
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>人员生日：</td>
								<td>
									<input readonly="readonly"  id="birthday" name="birthday"  class="laydate-icon form-control layer-date" aria-required="true" required/>
								</td>
							</tr>
